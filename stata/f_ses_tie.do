...
twoway (connected low_own_ses tie_threshold, lcolor("130 202 157") mcolor("130 202 157") lpattern(solid) lwidth(medthick)) ///
       (connected mid_own_ses tie_threshold, lcolor("246 207 113") mcolor("246 207 113") lpattern(solid) lwidth(medthick)) ///
       (connected high_own_ses tie_threshold, lcolor("136 132 216") mcolor("136 132 216") lpattern(solid) lwidth(medthick)) ///
		, ///
