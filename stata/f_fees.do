...
forvalues i = 1/3 {
    global fee_mean`i'S = (own_fee[`i']/1000)*(0.240745)*20
} 
restore 
...
forvalues i = 1/3 {
    global fee_mean`i'A = (other_fee[`i']/1000)*(0.240745)*20
} 
restore 
...
forvalues i = 1/3 {
    global fee_mean`i' = (other_fee[`i']/1000)*(0.240745)*20
    global fee_sd`i' = (sd_fee[`i']/1000)*(0.240745)*20
    global fee_n`i' = n[`i']
    global fee_se`i' = (se[`i']/1000)*(0.240745)*20
    global fee_ci_lower`i' = (other_fee[`i']/1000)*(0.240745)*20 - 1.96*(se[`i']/1000)*(0.240745)*20
    global fee_ci_upper`i' = (other_fee[`i']/1000)*(0.240745)*20 + 1.96*(se[`i']/1000)*(0.240745)*20
}
