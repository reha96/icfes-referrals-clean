...
cls
prtesti ${n_low} ${prop_low_low} ${prop_A_low}    // Low vs Low at uni
prtesti ${n_low} ${prop_low_middle} ${prop_A_middle}
prtesti ${n_low} ${prop_low_high} ${prop_A_high}  
...
prtesti ${n_high} ${prop_high_middle} ${prop_A_middle}
prtesti ${n_high} ${prop_high_high} ${prop_A_high}  
