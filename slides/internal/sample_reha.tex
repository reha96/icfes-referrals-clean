...
\begin{frame}{Network size and tie strength by semester}
    \begin{columns}[T]
        \begin{column}{0.38\textwidth}
            \vspace{2em}
            \begin{itemize}
                \item Classes taken together increases over time
                % \pause
        ...
        \begin{column}{0.62\textwidth}
            \centering
            \includegraphics[width=0.95\columnwidth]{/Users/reha.tuncer/Documents/GitHub/icfes-referrals/figures/connection_tie.png}
...
\begin{frame}{Network connections by SES}
    \begin{columns}[T]
        \begin{column}{0.38\textwidth}
            \vspace{2em}
            \begin{itemize}
                \item Small monotonic decrease in connections across SES
                % \pause
            \end{itemize}
        \end{column}
        \begin{column}{0.62\textwidth}
...
\begin{frame}{Network composition by SES}
    \begin{columns}[T]
        \begin{column}{0.38\textwidth}
            \vspace{2em}
            \begin{itemize}
...
\begin{frame}{Network performance by SES}
    \begin{columns}[T]
        \begin{column}{0.38\textwidth}
            \vspace{2em}
            \begin{itemize}
        ...
        \begin{column}{0.62\textwidth}
            \centering
            \includegraphics[width=0.95\columnwidth]{/Users/reha.tuncer/Documents/GitHub/icfes-referrals/figures/network_performance.png}
    ...
    \begin{columns}[T]
        \begin{column}{0.38\textwidth}
            ...
            \begin{itemize}
                ...
                % \pause
                \item No treatment effect on the referred for reading score or for tie strength (all $p > 0.08$)
            \end{itemize}
        \end{column}
        \begin{column}{0.62\textwidth}
            \centering
    ...
    \begin{columns}[T]
        \begin{column}{0.38\textwidth}
            ...
            \begin{itemize}
                ...
                % \pause
                \item No treatment effect on the referred for math score or for tie strength (all $p > 0.1$)
            \end{itemize}
        \end{column}
        \begin{column}{0.62\textwidth}
            \centering
...
\begin{frame}{Referral distribution and performance by SES}
    \centering
    \begin{columns}
        \begin{column}{0.45\textwidth}
            \centering
            \includegraphics[width=\textwidth]{/Users/reha.tuncer/Documents/GitHub/icfes-referrals/figures/referral_rates.png}
            \label{fig:baseline_rates}
        \end{column}
        \hfill
        \begin{column}{0.45\textwidth}
            \centering
            \includegraphics[width=\textwidth]{/Users/reha.tuncer/Documents/GitHub/icfes-referrals/figures/referral_performance.png}
...
\begin{frame}{Is there a Low-SES bias in Reading referrals?}
    \begin{columns}[T]
        \begin{column}{0.38\textwidth}
            \vspace{2em}
            \begin{itemize}% [<+->] % This creates incremental reveal for all items
