...
\begin{frame}{Referrer network performance by SES}
    \begin{columns}[T]
        \begin{column}{0.38\textwidth}
            \vspace{2em}
            \begin{itemize}
                \item Area specific network-level standardization
                \pause
    ...
    \begin{columns}[T]
        \begin{column}{0.38\textwidth}
            ...
            \begin{itemize}
                ...
                \pause
                \item No treatment effect on reading score or on tie strength (all $p > 0.08$)
            \end{itemize}
        \end{column}
        \begin{column}{0.62\textwidth}
            \centering
    ...
    \begin{columns}[T]
        \begin{column}{0.38\textwidth}
            ...
            \begin{itemize}
                ...
                \pause
                \item No treatment effect on math score or on tie strength (all $p > 0.1$)
            \end{itemize}
        \end{column}
        \begin{column}{0.62\textwidth}
            \centering
