...
\begin{figure}[H]
  \centering
  \caption{Network size and courses taken together by time spent at UNAB}\label{share_same_ses_by_tie}
  \includegraphics[width=0.6\linewidth]{../figures/share_same_ses_by_tie.png}
  \begin{tablenotes}
    \footnotesize
    \item[] \textit{Note:} This figure displays the average share of same-SES connections for low-, middle-, and high-SES as a function of the average number of courses taken together with network members. Low- and high-SES networks both become more homogenous as the average number of courses taken together with their connections increase.
  \end{tablenotes}
\end{figure}
