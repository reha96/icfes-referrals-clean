...
\begin{table}[H]
  ...
  \begin{table}[H]
    ...
    \begin{tablenotes}[flushleft]
    \footnotesize
    \item[] \textit{Note:} Standard errors in parentheses. All scores are standardized (z-scores). Tie strength measures the number of courses taken together. Low-SES indicates the share of participants in estrato 1 or 2. \# connections represents the size of the choice set.
    \end{tablenotes}
  ...
  \begin{table}[H]
    \caption{Math Referrals by own SES and Treatment}
    \centering
    \begin{tabular}{lcccc}
    \hline
    & \multicolumn{2}{c}{Baseline} & \multicolumn{2}{c}{Bonus} \\
    \cline{2-5}
    & Choice Set & Nominated & Choice Set & Nominated \\
    \hline
    Low-SES & 0.358 & 0.483 & 0.368 & 0.508 \\
    Middle-SES & 0.527 & 0.595 & 0.517 & 0.527 \\
    High-SES  & 0.202 & 0.161 & 0.196 & 0.259 \\
    \hline
    Observations & 65,103 & 348 & 62,378 & 321 \\
    \hline
    \end{tabular}
    \label{tab:social_class_nominations}
\end{table}

\begin{table}[H]
    \caption{Verbal Referrals by own SES and Treatment}
    \centering
    \begin{tabular}{lcccc}
    \hline
    & \multicolumn{2}{c}{Baseline} & \multicolumn{2}{c}{Bonus} \\
    ...
    & Choice Set & Nominated & Choice Set & Nominated \\
    \hline
    Low-SES  & 0.365 & 0.464 & 0.370 & 0.554 \\
    Middle-SES & 0.527 & 0.570 & 0.513 & 0.512 \\
    High-SES & 0.199 & 0.200 & 0.192 & 0.310 \\
    \hline
    Observations & 66,674 & 351 & 61,500 & 322 \\
    \hline
    \end{tabular}
    \label{tab:social_class_nominations_verbal}
\end{table}
